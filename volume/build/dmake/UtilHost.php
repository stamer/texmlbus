...
class UtilHost
{
    ...
    public static function checkHosts(&$hosts)
    {
        ...
        foreach ($hosts as $hostkey => $val) {
            ...
            if ($return_var) {
                ...
                $hosts[$hostkey]['memlimitRss'] = $memLimit['rss'];
                $hosts[$hostkey]['memlimitVirtual'] = $memLimit['virtual'];
    ...
    public static function getDockerWorkers()
    {
        ...
        exec('/usr/bin/nslookup worker. 2>&1', $output, $return_var);
